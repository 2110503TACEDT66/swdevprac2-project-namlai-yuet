        ...
        <div className="w-full flex flex-col justify-center items-center mt-[70px] mb-[70px]">
            ...
            <div className="flex justify-center mt-[80px] items-center">
                <div className="text-center text-black text-2xl mx-[180px] justify-center">
                    ...
                    <button className='text-lg text-black bg-white border-[1px] border-black font-semibold px-[45px] py-[5px] rounded hover:shadow-lg mt-[40px]'>Car search</button>
                </div>
                <div className="text-center text-black text-2xl mx-[180px] justify-center">
                    ...
                    <button className='text-lg text-black bg-white border-[1px] border-black font-semibold px-[45px] py-[5px] rounded hover:shadow-lg mt-[40px]'>Booking now</button>
                </div>
                <div className="text-center text-black text-2xl mx-[180px] justify-center">
